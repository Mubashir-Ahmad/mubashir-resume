    ...
    <>
      <div className="main_container">
        <nav className="nav_bg py-5">
          ...
          <a href="https://www.linkedin.com/in/mubbashir-ahmad-a32b10231/" target="_blank" className="sidebar-items linkedin">
          ...
          <a href="https://drive.google.com/file/d/13nmBhtQDBNQm2KCz5VYbNEvo2B4lAKg_/view?usp=sharing" target="_blank" className="sidebar-items profile">
        ...
        <div className="sidebar">
          <a href="https://www.linkedin.com/in/mubbashir-ahmad-a32b10231/" target="_blank" className="sidebar-item linkedin">
            <Image src={img6} alt="LinkedIn" className="icon" />
            <span className="tooltip">LinkedIn</span>
          </a>
          ...
          <a href="https://drive.google.com/file/d/13nmBhtQDBNQm2KCz5VYbNEvo2B4lAKg_/view?usp=sharing" target="_blank" className="sidebar-item profile">
            <Image src={img9} alt="Profile" className="icon" />
            <span className="tooltip">Resume</span>
          </a>
        </div>
